package com.soham.foodcare.activity.adapter
...
import com.soham.foodcare.R
import com.soham.foodcare.activity.activities.RestaurantMenuActivity
import com.soham.foodcare.activity.database.RestaurantDatabase
import com.soham.foodcare.activity.database.RestaurantEntity
import com.soham.foodcare.activity.model.Restaurant
...
class DashboardFragmentAdapter(val context: Context, var itemList: ArrayList<Restaurant>) :
    ...
    override fun onBindViewHolder(holder: ViewHolderDashboard, position: Int) {
        ...
        Picasso.get().load(restaurant.restaurantImage).error(R.drawable.ic_default_restaurant_image)
